...
const orgs: { name: string; url: string | null; city: string; desc: string }[] = [
  ...
  { name: "Indian Association Berne", url: null, city: "Bern", desc: "Community events, cultural programmes and support for Indians in the capital." },
  { name: "Indian Cultural Association Basel (ICAS)", url: null, city: "Basel", desc: "Cultural events, Diwali celebrations and community welfare for Basel's Indian community." },
  ...
  { name: "Gujarati Samaj Switzerland", url: null, city: "Nationwide", desc: "Cultural events, language classes and support for Gujarati-speaking Indians across Switzerland." },
  { name: "Maharashtra Mandal Switzerland", url: null, city: "Nationwide", desc: "Marathi culture, Ganesh Chaturthi, and community welfare for Maharashtrians." },
  { name: "Tamil Sangam Switzerland", url: null, city: "Zurich/Basel", desc: "Tamil cultural events, Pongal celebrations, and Tamil language education." },
  { name: "Telugu Association Switzerland (TAS)", url: null, city: "Nationwide", desc: "Telugu cultural events, Ugadi, and community network for Telugu speakers." },
  { name: "Punjabi Cultural Association", url: null, city: "Zurich", desc: "Punjabi culture, Lohri, Baisakhi celebrations and community events." },
  { name: "Kannada Koota Switzerland", url: null, city: "Zurich", desc: "Kannada Rajyotsava, Ugadi and community events for Kannadigas." },
  { name: "Hindu Swayamsevak Sangh Switzerland", url: null, city: "Nationwide", desc: "Hindu cultural values, yoga, and youth development programmes." },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {orgs.map((org) =>
            org.url ? (
              ...
              <div key={org.name} className="glass rounded-xl p-5">
                <div className="flex items-start justify-between gap-2 mb-2">
                  <h3 className="font-semibold text-white text-sm leading-tight">{org.name}</h3>
                  <span className="shrink-0 text-xs px-2 py-0.5 rounded-full bg-orange-500/15 text-orange-400 border border-orange-500/20">{org.city}</span>
                </div>
                <p className="text-slate-400 text-xs leading-relaxed">{org.desc}</p>
              </div>
