...
export const UPCOMING_EVENTS = [
  ...
  {
    title: "Ras Garba / Navratri Baden 2026",
    date: "Oct 2026",
    location: "Sportausbildungszentrum Mülimatt, Windisch",
    category: "Cultural",
    description: "Annual Ras Garba celebration for Navratri in the Aargau region. Traditional Garba and Dandiya Raas with live music. Organised by the Ras Garba Association Baden.",
    organiser: "Ras Garba Association Baden",
    color: "bg-fuchsia-500",
    url: "",
    image: "https://images.unsplash.com/photo-1563237023-b1e970526dcb?w=600&auto=format&fit=crop",
  },
  {
    title: "YUVA Diwali — Yuvaali Festival of Lights",
    date: "Nov 2026",
    location: "EPFL / UNIL campus, Lausanne",
    category: "Festival",
    description: "YUVA's flagship annual Diwali celebration at EPFL-UNIL — 250+ guests, cultural performances, diyas, Indian food and community. Open to all in Romandy.",
    organiser: "YUVA – Indians at EPFL / UNIL",
    color: "bg-orange-500",
    url: "https://www.epfl.ch/campus/associations/yuva/",
    image: "https://images.unsplash.com/photo-1574169208507-84376144848b?w=600&auto=format&fit=crop",
  },
  {
    title: "Kalamela Arts Festival — KELI Swiss",
    date: "Sep–Oct 2026",
    location: "Schlieren, Zurich",
    category: "Arts",
    description: "Keliswiss's renowned annual Kalamela arts event — classical Indian music, Bharatanatyam, Mohiniyattam and folk arts performances. One of the largest Kerala cultural events in Switzerland.",
    organiser: "Keli Swiss (KELI)",
    color: "bg-teal-500",
    url: "https://www.keliswiss.org/",
    image: "https://images.unsplash.com/photo-1545128485-c400e7702796?w=600&auto=format&fit=crop",
  },
  {
    title: "SMA Basel Ponnonam / Onam Celebration",
    date: "Aug–Sep 2026",
    location: "Basel",
    category: "Cultural",
    description: "Swiss Malayalee Association Basel's annual Ponnonam celebration — pookalam flower carpet, Onam Sadya feast, classical music, Thiruvathirakali dance and folk arts.",
    organiser: "Swiss Malayalee Association Basel (SMA Basel)",
    color: "bg-green-600",
  ...
  },
  {
    ...
    date: "Summer 2026",
    location: "Zurich / Opfikon region",
    category: "Sports",
