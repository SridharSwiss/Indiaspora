      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <div className="glass rounded-2xl p-6 border border-yellow-500/20">
          ...
          <div className="space-y-1 text-sm text-white/70">
            ...
            <p className="mt-3 text-white/60">The Embassy covers Switzerland and Liechtenstein. Services include passport renewal, OCI card applications, emergency travel documents, and visa issuance for Swiss nationals wishing to visit India.</p>
          </div>
        </div>
