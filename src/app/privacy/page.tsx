  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-24 text-slate-300">
      ...
      <section className="mb-8">
        ...
        <p>IndiaSwiss Community Hub (&ldquo;IndiaSwiss&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) operates the website at <strong>indiaspora.ch</strong>. We are based in Switzerland and comply with the Swiss Federal Act on Data Protection (nDSG) and, where applicable, the EU General Data Protection Regulation (GDPR).</p>
        <p className="mt-2">Contact: <a href="mailto:hello@indiaspora.ch" className="text-indigo-400 hover:underline">hello@indiaspora.ch</a></p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>Under the nDSG and GDPR you have the right to access, rectify, erase, or restrict processing of your personal data. To exercise these rights, email <a href="mailto:hello@indiaspora.ch" className="text-indigo-400 hover:underline">hello@indiaspora.ch</a>. You also have the right to lodge a complaint with the Swiss Federal Data Protection and Information Commissioner (FDPIC).</p>
      </section>
