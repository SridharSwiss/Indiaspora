...
const PARTICLES = [
  ...
  { w: 3, h: 3, bg: "#f97316", l: 60, t: 85, dur: 6, delay: 3 },
  { w: 5, h: 5, bg: "#3b82f6", l: 25, t: 55, dur: 8, delay: 1.5 },
];
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0" aria-hidden>
        {/* Static gradient orbs — no animation to avoid repaint */}
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-orange-600/10 rounded-full blur-2xl" />
        <div className="absolute bottom-1/4 right-1/4 w-56 h-56 bg-blue-600/10 rounded-full blur-2xl" />
        {/* Grid */}
        <div
      ...
      {/* Decorative Ashoka Chakra - static, no spin */}
      <div className="absolute top-20 right-10 w-32 h-32 opacity-[0.04]" aria-hidden>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16">
        {/* Badge */}
        <div
          className={`inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-sm text-orange-300 mb-8 transition-all duration-700 ${
        ...
        {/* Headline */}
        <h1
          className={`text-5xl sm:text-6xl lg:text-8xl font-bold leading-tight mb-6 transition-all duration-700 delay-100 ${
        ...
        <p
          className={`text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed transition-all duration-700 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
          The definitive platform for Indians living in Switzerland — discover restaurants, associations, events, business networks, temples, and everything you need to thrive in Switzerland.
        </p>
        ...
        >
          <button className="group flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold hover:from-orange-600 hover:to-amber-600 transition-all shadow-xl shadow-orange-500/30 hover:shadow-orange-500/50 hover:-translate-y-0.5">
        ...
        {/* Stats */}
        <div
          className={`grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto transition-all duration-700 delay-500 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
          {STATS.map((stat) => (
